...
def main() -> int:
    ...
    machine = environment()
    # The round trip is a measurement, not a machine fact, but it is published with the machine
    # because it is what the `broker_bound` arithmetic is done with and a reader checking that
    # arithmetic needs it beside the numbers.
    machine["round_trip"] = (
