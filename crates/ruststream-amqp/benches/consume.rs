...
//! Consuming a small JSON body from a queue: the subscription yields the delivery, the dispatcher
//! decodes it into a struct, the handler reads a field, and the runtime accepts it.
