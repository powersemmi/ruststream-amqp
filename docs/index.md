...
`ruststream_amqp::prelude::*` is the one import a service file writes. It re-exports the broker,
the address descriptor, the publish policies, and the framework's own prelude.
