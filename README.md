...
Implemented and verified against ActiveMQ Artemis (the framework's conformance lifecycle, request/reply, and transactions suites run in CI against a live broker). Published on crates.io, tracking the `ruststream` 0.6 line. The design issue is [powersemmi/ruststream#187](https://github.com/powersemmi/ruststream/issues/187).
